                ...
                <center style="width: 70%; margin: auto;">
                    ...
                    <form class="form-horizontal" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" placeholder="Tên sản phẩm" name="tensanpham" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Giá nhập</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="" placeholder="Giá nhập" name="gianhap" oninput="this.value = Math.abs(this.value)" min="0" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Giá bán</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="" placeholder="Giá bán" name="giaban" oninput="this.value = Math.abs(this.value)" min="0" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Số lượng</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="" placeholder="Số lượng" name="soluong" oninput="this.value = Math.abs(this.value)" min="0" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">Xuất xứ</label>
                            <div class="col-sm-10">
                                <select name="xuatxu" id="" class="form-control" required>
                                    <option value=""></option>
                                    <?php
    ...
    if (isset($_POST["btn_submit"])) {
        ...
        if ($check == true) {
            ...
            if (file_exists($file_path)) {
                echo "<p style='text-align: center;'>Tên ảnh đã có trên hệ thống</p>";
                $check_img == false;
                die();
            }
