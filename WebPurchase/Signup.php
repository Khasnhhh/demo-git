    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form method="post">
                ...
                <div class="form-group"><button class="btn btn-success btn-block" type="submit" name="submit">Đăng ký</button></div><a class="already" href="../index.php">Bạn đã có tài khoản? Đăng nhập tại đây.</a>
            </form>
        </div>
    </div>
</body>
