    ...
    <div class="register-photo">
        <div class="form-container">
            ...
            <form method="post">
                ...
                <div class="form-group"><button class="btn btn-success btn-block" type="button" name="prev"><a href="./Home.php" style="color: white;">Trở về</a></button></div>
            </form>
        </div>
    </div>
</body>
...
<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $sql_update = "UPDATE taikhoan_kh SET MatKhau = '$password' WHERE ID = $IDTK";
        var_dump($sql_update);
